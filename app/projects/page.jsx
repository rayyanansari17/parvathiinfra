...
const PROJECTS = [
        {
                id: 'the-view',
                title: 'THE VIEW',
                sub: 'Kadthal · Flagship · HMDA & FCDA (HMDA) Approved',
                status: 'Now Selling',
                img: MASTER_PLAN_IMAGE,
                to: '/the-view',
                testid: PROJECTS_PAGE.projectCardTheView,
                copy: 'Our flagship at Kadthal, on NH-44 (Bengaluru Highway). HMDA & FCDA (HMDA) approved with clear legal title, wide blacktop roads, underground services and avenue plantation.',
        },
        {
